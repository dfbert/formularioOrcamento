  ...
  <div>
    ...
    <div class="row mb-4">
      ...
      <div class="col-6 text-left mb-3 d-flex align-items-center">
        <select name="valorSeguro" id="valorSeguro" v-model="cotacao.questionarios['5'].valorSeguro">
      ...
      <div class="col-6 text-left mb-3 d-flex align-items-center">
        <select name="rendaMensal" id="rendaMensal" v-model="cotacao.questionarios['5'].rendaMensal">
      ...
      <div class="col-6 text-left mb-3 d-flex align-items-center">
        <div class="row w-100">
          <div class="col">
            <label for="nao">
              <input type="radio" id="nao" name="fumante" value="nao" v-model="cotacao.questionarios['5'].fumante" />Não
            </label>
          </div>
          <div class="col">
            <label for="sim">
              <input type="radio" id="sim" name="fumante" value="sim" v-model="cotacao.questionarios['5'].fumante" />Sim
            </label>
          </div>
        </div>
      </div>
...
export default {
  ...
  computed: {
    fumanteValidation() {
      if (!this.cotacao.questionarios['5'].fumante) {
        return {
          valido: false,
          mensagemErro: 'Você precisa nos informar se é fumante ou não',
        };
      } else {
        return { valido: true };
      }
