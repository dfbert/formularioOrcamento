<template>
  <div>
    <div class="row">
      <div
        class="message"
      >Para definir o VALOR do Investimento, escolha o seu perfil de risco e modalidade que deseja investir. Tá com dúvida? Fale com nosso Consultor de Vendas!</div>
    </div>
    <div class="row mb-4">
      ...
      <div class="col-6 text-left mb-3 d-flex align-items-center">
        ...
        >
          <option
            value="Sigo o conselho de alguém que conheça mais o mercado que eu e seja da minha confiança"
      ...
      <div class="col-6 text-left mb-3 d-flex align-items-center">
        ...
        >
          <option
            value="Renda a longo prazo para aposentadoria"
          >Renda a longo prazo para aposentadoria</option>
