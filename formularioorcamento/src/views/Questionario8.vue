<template>
  <div>
    <div class="row">
      <div class="message">
        * Entre os mais vendido nos últimos anos para sua atividade está o Seguro de Responsabilidade Civil Profissional, também conhecido como Seguro de Erros e Omissões Profissionais, que atenua judicial e financeiramente eventuais falhas na execução do seu trabalho.
      </div>
    </div>
    <div class="row mb-4">
      <div class="col-6 text-right mb-3 d-flex align-items-center">
        <label
          for="reclamacaoJudicial12Meses"
        >Já SOFREU qualquer tipo de reclamação judicial, extrajudicial ou disciplinar em sua atividade profissional nos últimos 12 meses?</label>
        <p></p>
      </div>
      ...
      <div class="col-6 text-right mb-3 d-flex align-items-center">
        <label
          for="reclamacaoJudicial5Anos"
        >Já SOFREU qualquer tipo de reclamação judicial, extrajudicial ou disciplinar em sua atividade profissional nos últimos 5 anos?</label>
        <p></p>
      </div>
      <div class="col-6 text-left mb-3 d-flex align-items-center">
        <select
      ...
      <div class="col-6 text-right mb-3 d-flex align-items-center">
        <label
          for="conhecimentoFato"
        >Você tem CONHECIMENTO de qualquer fato ou circunstância que possa gerar uma reclamação extrajudicial, processo judicial civil, criminal ou ético administrativo ou de qualquer tipo similar de pedido de reparação de danos causados pela prestação de seus serviços? </label>
        <p></p>
      </div>
      <div class="col-6 text-left mb-3 d-flex align-items-center">
        <select
          name="conhecimentoFato"
          id="conhecimentoFato"
          v-model="cotacao.questionarios['7'].conhecimentoFato"
        >
      ...
      <div class="col-6 text-left mb-3 d-flex align-items-center">
        <select
          ...
          id="faturamentoAnual"
          v-model="cotacao.questionarios['7'].faturamentoAnual"
        >
