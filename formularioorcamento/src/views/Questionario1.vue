  ...
  <div>
    ...
    <div class="row mb-4">
      <div class="col-12 mb-2">
        Selecione TODOS os dispositivos de proteção de INCÊNDIO que você possui:
      </div>
      ...
      <div
        ...
        :class="{
          ...
          'p-1': true,
          opcao: true,
          ativo: dispSeleCod.incendio.includes(dispositivo.codigo),
        }"
      ...
      <div class="col-12 mt-4 mb-2">
        Selecione TODOS os dispositivos de proteção de ROUBO que você possui:
      </div>
      ...
      <div
        ...
        :class="{
          ...
          'p-1': true,
          opcao: true,
          ativo: dispSeleCod.roubo.includes(dispositivo.codigo),
        }"
  ...
  data: () => ({
    ...
    dispositivosIncendio: [
      ...
      },
      {
        ...
        icon: 'energy',
        descricao: 'O imóvel não possui nenhum dispositivo de segurança para evitar e proteger contra incêndios',
      },
    ],
    dispositivosRoubo: [
      {
      ...
      },
      {
        ...
        codigo: 'nenhumRoubo',
        icon: 'energy',
        descricao: 'O imóvel não possui nenhum dispositivo de proteção e de segurança física e do patrimônio',
      },
    ],
  }),
